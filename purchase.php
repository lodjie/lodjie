        ...
        <h1 class="h1"> Purchasing</h1>
            ...
            <table class="display text-center" id="myTable">
                ...
                <?php
                    include"koneksi.php";
                    $no = 1;
                    $data = mysqli_query($conn, "SELECT * from purchasing ");
                    foreach ($data as $row) {
                        ?>
                    <tr>
                        <td>
                        ...
                        <td>
                            <?php echo $row['kodepurchase']; ?>
                        </td>
                        <td>
                            <?php echo $row['kodebarang']; ?>
                        </td>
                        <td>
                            <?php echo $row['kodesupplier']; ?>
                        </td>
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
            ...
            <?php
                            ...
                            $query = "SELECT max(kodepurchase) as maxKode FROM purchasing";
                            $hasil = mysqli_query($conn, $query);
                            $data = mysqli_fetch_array($hasil);
                            $kodepurchase = $data['maxKode'];
                            
                            // mengambil angka atau bilangan dalam kode anggota terbesar,
                            // dengan cara mengambil substring mulai dari karakter ke-1 diambil 6 karakter
                            // misal 'BRG001', akan diambil '001'
                            // setelah substring bilangan diambil lantas dicasting menjadi integer
                            $noUrut = (int) substr($kodepurchase, 3, 3);
                            ...
                            $char = "P";
                            $kodepurchase = $char . sprintf("%04s", $noUrut);
            ...
            <div class="d-block asd">
                <label>
                <input type="text" id="kodepurchase" name="kodepurchase" value="<?php echo $kodepurchase; ?>"  required />
                <div class="label-text">Kode Purchase</div>
                </label>
                <br />
                 <div class="form-group">
                    <label for="example">Kode Barang</label>
                    <select class="form-control" name="barang" id="example" width="50%">
                        <?php 
                        // include 'koneksi.php';
                        ...
                        while ($hasil1 = mysqli_fetch_array ($data1))
                            {
                        ?>
                        <option value="<?php echo $hasil1['kodebarang'] ?> ">
                            <?php echo $hasil1['name'] ?></option>
                        <? }
                        ?>
                ...
                <br />
                 <div class="form-group">
                    <label for="example">Kode Supplier</label>
                    <select class="form-control" name="supplier" id="example" width="50%">
                        <?php 
                        // include 'koneksi.php';
                        ...
                        while ($hasil1 = mysqli_fetch_array ($data1))
                            {
                        ?>
                        <option value="<?php echo $hasil1['kodesupplier'] ?> ">
                            <?php echo $hasil1['perusahaan'] ?></option>
                        <? }
                        ?>
